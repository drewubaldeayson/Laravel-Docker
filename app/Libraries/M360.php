...
class M360
{
	...
	{
		$this->url              = new Uri(env('M360_HOST'));
		$this->username 		= env('M360_USERNAME');
		$this->password 		= env('M360_PASSWORD');
		$this->shortcode_mask 	= env('M360_SHORTCODE_MASK');
		$this->success 			= false;
		$this->environment 		= env('M360_ENV');
	}
